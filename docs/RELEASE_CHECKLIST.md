...
- [x] Release tests pass: 104/104.
- [x] Debug build produces zero warnings and errors.
- [x] `dotnet format --verify-no-changes` passes.
- [x] The WPF runtime UI probe passes for the main window, translation settings, and independent AI reading window.
...
- [x] Review privacy wording and known limitations.
...
- [x] Configure the intended GitHub remote, review the first local commit, and confirm the repository is public.
